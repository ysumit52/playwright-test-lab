...
let AuthController = class AuthController {
    ...
    async login(dto, response) {
        ...
        response.cookie(auth_types_1.AUTH_COOKIE_NAME, accessToken, {
            httpOnly: true,
            sameSite: 'lax',
    ...
    logout(response) {
        response.clearCookie(auth_types_1.AUTH_COOKIE_NAME, { path: '/' });
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "adminArea", null);
