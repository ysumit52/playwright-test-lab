...
var PendingTasksInternal = class {
	constructor() {
		...
		_defineProperty(this, "pendingTask", new import_cjs.BehaviorSubject(false));
...
var QueryList = class {
	get changes() {
		var _this$_changes;
		return (_this$_changes = this._changes) !== null && _this$_changes !== void 0 ? _this$_changes : this._changes = new import_cjs.Subject();
	}
...
function afterEveryRender(callbackOrSpec, options) {
	...
	(_options$injector = options === null || options === void 0 ? void 0 : options.injector) !== null && _options$injector !== void 0 || inject(Injector);
...
function afterNextRender(callbackOrSpec, options) {
	...
	(_options$injector2 = options === null || options === void 0 ? void 0 : options.injector) !== null && _options$injector2 !== void 0 || inject(Injector);
	return NOOP_AFTER_RENDER_REF;
}
...
var ApplicationRef = class {
	...
	constructor() {
		...
		_defineProperty(this, "afterTick", new import_cjs.Subject());
...
var ChangeDetectionSchedulerImpl = class {
	constructor() {
		...
		_defineProperty(this, "subscriptions", new import_cjs.Subscription());
		...
		return _asyncToGenerator(function* () {
			...
			try {
				...
				if (isSignal(stream)) {
					...
					saveToTransferState(untracked(stream), _this.transferCacheKey, _this.transferState);
				} else {
					...
					saveToTransferState(resolvedStream ? untracked(resolvedStream) : void 0, _this.transferCacheKey, _this.transferState);
				}
			} catch (err) {
...
_defineProperty(class EventContract {
...
var ZoneStablePendingTask = class {
	constructor() {
		_defineProperty(this, "subscription", new import_cjs.Subscription());
		_defineProperty(this, "initialized", false);
		_defineProperty(this, "zone", inject(NgZone));
...
//#endregion
export { isDevMode as $, ɵɵdeferPrefetchWhen as $a, _global as $c, unwrapSafeValue as $i, Output as $n, ɵɵpipeBind1 as $o, findLocaleData as $r, ɵɵtextInterpolate8 as $s, AfterRenderManager as $t, contentChild as A, ɵɵdeclareLet as Aa, Injector as Ac, provideZonelessChangeDetection as Ai, ɵɵdefineInjector as Al, HydrationStatus as An, ɵɵi18n as Ao, _sanitizeUrl as Ar, ɵɵsanitizeResourceUrl as As, ɵɵngDeclareInjector as At, destroyPlatform as B, ɵɵdeferHydrateWhen as Ba, PLATFORM_ID as Bc, resetJitOptions as Bi, setAlternateWeakRefImpl as Bl, LOCALE_ID as Bn, ɵɵinterpolate2 as Bo, bypassSanitizationTrustUrl as Br, ɵɵsyntheticHostListener as Bs, computed as Bt, ViewChildren as C, ɵɵconditional as Ca, EventEmitter as Cc, noSideEffects as Ci, setInjectorProfilerContext as Cl, DeferBlockState as Cn, ɵɵforeignComponent as Co, TracingService as Cr, ɵɵrepeaterTrackByIdentity as Cs, ɵassertType as Ct, assertPlatform as D, ɵɵcontentQuerySignal as Da, INJECTOR_SCOPE as Dc, provideAppInitializer as Di, truncateMiddle as Dl, Host as Dn, ɵɵgetCurrentView as Do, ViewEncapsulation$1 as Dr, ɵɵresolveDocument as Ds, ɵɵngDeclareDirective as Dt, annotateForHydration as E, ɵɵcontentQuery as Ea, INJECTOR$1 as Ec, performanceMarkFeature as Ei, stringify as El, ElementRef as En, ɵɵgetComponentDepsFactory as Eo, ViewContainerRef as Er, ɵɵresolveBody as Es, ɵɵngDeclareComponent as Et, createPlatformFactory as F, ɵɵdeferHydrateOnIdle as Fa, NG_MOD_DEF as Fc, registerNgModuleType as Fi, ɵɵnamespaceHTML as Fl, Injectable as Fn, ɵɵi18nPostprocess as Fo, asNativeElements as Fr, ɵɵsetComponentScope as Fs, OutputEmitterRef as Ft, getModuleFactory as G, ɵɵdeferOnTimer as Ga, R3Injector as Gc, setClassMetadataAsync as Gi, NO_CHANGE as Gn, ɵɵinterpolate7 as Go, compileNgModuleDefs as Gr, ɵɵtextInterpolate as Gs, resource as Gt, enableProdMode as H, ɵɵdeferOnIdle as Ha, PROVIDED_ZONELESS as Hc, restoreComponentResolutionQueue as Hi, SIGNAL as Hl, MAX_ANIMATION_TIMEOUT as Hn, ɵɵinterpolate4 as Ho, compileComponent as Hr, ɵɵtemplate as Hs, getOutputDestroyRef as Ht, debounced as I, ɵɵdeferHydrateOnImmediate as Ia, NG_PIPE_DEF as Ic, renderDeferBlockState as Ii, ɵɵnamespaceMathML as Il, Input as In, ɵɵi18nStart as Io, bypassSanitizationTrustHtml as Ir, ɵɵsetNgModuleScope as Is, ResourceDependencyError as It, injectAsync as J, ɵɵdeferPrefetchOnIdle as Ja, TransferState as Jc, setTestabilityGetter as Ji, NgModuleFactory as Jn, ɵɵinvalidFactory as Jo, createNgModule as Jr, ɵɵtextInterpolate3 as Js, ANIMATIONS_DISABLED as Jt, getNgModuleById as K, ɵɵdeferOnViewport as Ka, RuntimeError as Kc, setDocument as Ki, NO_ERRORS_SCHEMA as Kn, ɵɵinterpolate8 as Ko, compilePipe as Kr, ɵɵtextInterpolate1 as Ks, setInParamsFunction as Kt, declareExperimentalWebMcpTool as L, ɵɵdeferHydrateOnInteraction as La, NG_PROV_DEF as Lc, resetCompiledComponents as Li, ɵɵnamespaceSVG as Ll, JSACTION_BLOCK_ELEMENT_MAP as Ln, ɵɵinjectAttribute as Lo, bypassSanitizationTrustResourceUrl as Lr, ɵɵstoreLet as Ls, ResourceImpl as Lt, createComponent as M, ɵɵdeferEnableTimerScheduling as Ma, NG_DIR_DEF as Mc, publishNonCoreGlobalUtil as Mi, ɵɵenableBindings as Ml, IS_HYDRATION_DOM_REUSE_ENABLED as Mn, ɵɵi18nAttributes as Mo, afterNextRender as Mr, ɵɵsanitizeStyle as Ms, ɵɵngDeclarePipe as Mt, createOrReusePlatformInjector as N, ɵɵdeferHydrateNever as Na, NG_ELEMENT_ID as Nc, readHydrationInfo as Ni, ɵɵinject as Nl, IS_INCREMENTAL_HYDRATION_ENABLED as Nn, ɵɵi18nEnd as No, allLeavingAnimations as Nr, ɵɵsanitizeUrl as Ns, ɵɵngDeclareService as Nt, booleanAttribute as O, ɵɵcontrol as Oa, INTERNAL_APPLICATION_ERROR_HANDLER as Oc, provideIdleServiceWith as Oi, ɵunwrapWritableSignal as Ol, HostBinding as On, ɵɵgetInheritedFactory as Oo, ViewRef$1 as Or, ɵɵresolveWindow as Os, ɵɵngDeclareFactory as Ot, createPlatform as P, ɵɵdeferHydrateOnHover as Pa, NG_INJ_DEF as Pc, registerLocaleData as Pi, ɵɵinvalidFactoryDep as Pl, Inject as Pn, ɵɵi18nExp as Po, allowSanitizationBypassAndThrow as Pr, ɵɵsanitizeUrlOrResourceUrl as Ps, CACHE_ACTIVE as Pt, internalProvideZoneChangeDetection as Q, ɵɵdeferPrefetchOnViewport as Qa, ZONELESS_ENABLED as Qc, unregisterAllLocaleData as Qi, Optional as Qn, ɵɵpipe as Qo, enableProfiling$1 as Qr, ɵɵtextInterpolate7 as Qs, AcxViewEncapsulation as Qt, defaultIterableDiffers as R, ɵɵdeferHydrateOnTimer as Ra, NgZone as Rc, resetIncrementalHydrationEnabledWarnedForTests as Ri, ɵɵresetView as Rl, JSACTION_EVENT_CONTRACT as Rn, ɵɵinterpolate as Ro, bypassSanitizationTrustScript as Rr, ɵɵstyleMap as Rs, ResourceParamsStatus as Rt, ViewChild as S, ɵɵcomponentInstance as Sa, ErrorHandler as Sc, markForRefresh as Si, runInInjectionContext as Sl, DeferBlockBehavior as Sn, ɵɵenableIncrementalHydrationRuntime as So, TracingAction as Sr, ɵɵrepeaterCreate as Ss, ɵINPUT_SIGNAL_BRAND_WRITE_TYPE as St, afterRenderEffect as T, ɵɵconditionalCreate as Ta, IMAGE_CONFIG_DEFAULTS as Tc, patchComponentDefWithScope as Ti, store as Tl, EVENT_REPLAY_QUEUE as Tn, ɵɵforeignContentFn as To, USE_PENDING_TASKS as Tr, ɵɵreplaceMetadata as Ts, ɵɵngDeclareClassMetadataAsync as Tt, enableProfiling as U, ɵɵdeferOnImmediate as Ua, PendingTasks as Uc, setAllowDuplicateNgModuleIdsForTest as Ui, MissingTranslationStrategy as Un, ɵɵinterpolate5 as Uo, compileDirective as Ur, ɵɵtemplateRefExtractor as Us, isInParamsFunction as Ut, disableProfiling as V, ɵɵdeferOnHover as Va, PLATFORM_INITIALIZER as Vc, resolveComponentResources as Vi, setCurrentInjector as Vl, LocaleDataIndex as Vn, ɵɵinterpolate3 as Vo, clearResolutionOfComponentResourcesQueue as Vr, ɵɵsyntheticHostProperty as Vs, encapsulateResourceError as Vt, getCurrentClosestComponentInstance as W, ɵɵdeferOnInteraction as Wa, PendingTasksInternal as Wc, setClassMetadata as Wi, NOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR as Wn, ɵɵinterpolate6 as Wo, compileNgModule as Wr, ɵɵtext as Ws, linkedSignal as Wt, input as X, ɵɵdeferPrefetchOnInteraction as Xa, Version as Xc, triggerResourceLoading as Xi, NgModuleRef as Xn, ɵɵloadQuery as Xo, describeDomNode as Xr, ɵɵtextInterpolate5 as Xs, APP_INITIALIZER as Xt, injectChangeDetectorRef as Y, ɵɵdeferPrefetchOnImmediate as Ya, VERSION as Yc, transitiveScopesFor as Yi, NgModuleFactory$1 as Yn, ɵɵlistener as Yo, depsTracker as Yr, ɵɵtextInterpolate4 as Ys, APP_BOOTSTRAP_LISTENER as Yt, internalCreateApplication as Z, ɵɵdeferPrefetchOnTimer as Za, XSS_SECURITY_URL as Zc, twoWayBinding as Zi, NgModuleRef$1 as Zn, ɵɵnextContext as Zo, devModeEqual as Zr, ɵɵtextInterpolate6 as Zs, AcxChangeDetectionStrategy as Zt, PlatformRef as _, ɵɵarrowFunction as _a, DOCUMENT$1 as _c, isComponentDefPendingResolution as _i, makeStateKey as _l, DEFER_BLOCK_DEPENDENCY_INTERCEPTOR as _n, ɵɵelementContainer as _o, TRANSLATIONS_FORMAT as _r, ɵɵqueryAdvance as _s, viewChildren as _t, ContentChildren as a, ɵɵControlFeature as aa, ɵɵtwoWayProperty as ac, getDebugNode as ai, formatRuntimeError as al, ChangeDetectionStrategy as an, ɵɵdefineService as ao, RendererFactory2 as ar, ɵɵprojectionDef as as, output as at, REQUEST_CONTEXT as b, ɵɵclassMap as ba, EffectScheduler as bc, isSubscribable as bi, provideEnvironmentInitializer as bl, DebugEventListener as bn, ɵɵelementEnd as bo, TestabilityRegistry as br, ɵɵreference as bs, withI18nSupport as bt, EmbeddedViewRef as c, ɵɵInheritDefinitionFeature as ca, ɵɵviewQuerySignal as cc, getDocument as ci, getInjectableDef as cl, Component as cn, ɵɵdomElementContainer as co, SSR_CONTENT_INTEGRITY_MARKER as cr, ɵɵpureFunction1 as cs, provideExperimentalWebMcpTools as ct, HOST_TAG_NAME as d, ɵɵadvance as da, _asyncToGenerator as dc, getLocaleCurrencyCode as di, isEnvironmentProviders as dl, ComponentRef$1 as dn, ɵɵdomElementEnd as do, Service as dr, ɵɵpureFunction4 as ds, provideZoneChangeDetection as dt, ɵgetUnknownElementStrictMode as ea, ɵɵtextInterpolateV as ec, flushModuleScopingQueueAsMuchAsPossible as ei, assertInInjectionContext as el, ApplicationInitStatus as en, ɵɵdeferWhen as eo, Pipe as er, ɵɵpipeBind2 as es, maybeUnwrapDefaultExport as et, HostAttributeToken as f, ɵɵanimateEnter as fa, ANIMATION_MODULE_TYPE as fc, getLocalePluralCase as fi, isInjectable as fl, Console as fn, ɵɵdomElementStart as fo, SimpleChange as fr, ɵɵpureFunction5 as fs, reflectComponentType as ft, PROVIDED_NG_ZONE as g, ɵɵariaProperty as ga, ChangeDetectionScheduler as gc, inputBinding as gi, makeEnvironmentProviders as gl, DEFER_BLOCK_CONFIG as gn, ɵɵelement as go, TRANSLATIONS as gr, ɵɵpureFunctionV as gs, viewChild as gt, PERFORMANCE_MARK_PREFIX as h, ɵɵanimateLeaveListener as ha, CSP_NONCE as hc, inferTagNameFromDefinition as hi, isWritableSignal as hl, DEFAULT_LOCALE_ID as hn, ɵɵdomTemplate as ho, TESTABILITY_GETTER as hr, ɵɵpureFunction8 as hs, stopMeasuring as ht, ContentChild as i, ɵsetUnknownPropertyStrictMode as ia, ɵɵtwoWayListener as ic, getComponentInstanceDeepLinkId as ii, effect as il, CUSTOM_ELEMENTS_SCHEMA as in, ɵɵdefinePipe as io, Renderer2 as ir, ɵɵprojection as is, onIdle as it, contentChildren as j, ɵɵdefer as ja, NG_COMP_DEF as jc, provideZonelessChangeDetectionInternal as ji, ɵɵdisableBindings as jl, IS_ENABLED_BLOCKING_INITIAL_NAVIGATION as jn, ɵɵi18nApply as jo, afterEveryRender as jr, ɵɵsanitizeScript as js, ɵɵngDeclareNgModule as jt, compileNgModuleFactory as k, ɵɵcontrolCreate as ka, InjectionToken as kc, provideNgReflectAttributes as ki, ɵɵdefineInjectable as kl, HostListener as kn, ɵɵgetReplaceMetadataURL as ko, _sanitizeHtml as kr, ɵɵsanitizeHtml as ks, ɵɵngDeclareInjectable as kt, FactoryTarget as l, ɵɵNgOnChangesFeature as la, require_operators as lc, getHostElement as li, importProvidersFrom as ll, ComponentFactory as ln, ɵɵdomElementContainerEnd as lo, Sanitizer as lr, ɵɵpureFunction2 as ls, providePlatformInitializer as lt, KeyValueDiffers as m, ɵɵanimateLeave as ma, CONTAINER_HEADER_OFFSET as mc, getTransferState as mi, isStandalone as ml, DEFAULT_CURRENCY_CODE as mn, ɵɵdomProperty as mo, TESTABILITY as mr, ɵɵpureFunction7 as ms, startMeasuring as mt, CLIENT_RENDER_MODE_FLAG as n, ɵsetClassDebugInfo as na, ɵɵtrustConstantResourceUrl as nc, getAsyncClassMetadataFn as ni, convertToBitFlags as nl, Attribute as nn, ɵɵdefineDirective as no, QueryList as nr, ɵɵpipeBind4 as ns, model as nt, DefaultIterableDiffer as o, ɵɵExternalStylesFeature as oa, ɵɵvalidateAttribute as oc, getDeferBlocks as oi, forwardRef as ol, Compiler as on, ɵɵdirectiveInject as oo, RendererStyleFlags2 as or, ɵɵproperty as os, platformCore as ot, IterableDiffers as p, ɵɵanimateEnterListener as pa, APP_ID as pc, getSanitizationBypassType as pi, isSignal as pl, ControlFlowBlockType as pn, ɵɵdomListener as po, SkipSelf as pr, ɵɵpureFunction6 as ps, resourceFromSnapshots as pt, getPlatform as q, ɵɵdeferPrefetchOnHover as qa, SecurityContext as qc, setLocaleId as qi, NgModule as qn, ɵɵinterpolateV as qo, createEnvironmentInjector as qr, ɵɵtextInterpolate2 as qs, untracked as qt, ChangeDetectorRef as r, ɵsetUnknownElementStrictMode as ra, ɵɵtwoWayBindingSet as rc, getClosestComponentName as ri, createInjector as rl, COMPILER_OPTIONS as rn, ɵɵdefineNgModule as ro, ReflectionCapabilities as rr, ɵɵpipeBindV as rs, numberAttribute as rt, ENABLE_ROOT_COMPONENT_BOOTSTRAP as s, ɵɵHostDirectivesFeature as sa, ɵɵviewQuery as sc, getDirectives as si, getComponentDef as sl, CompilerFactory as sn, ɵɵdomElement as so, SHARED_STYLES_HOST as sr, ɵɵpureFunction0 as ss, provideCheckNoChangesConfig as st, ApplicationModule as t, ɵgetUnknownPropertyStrictMode as ta, ɵɵtrustConstantHtml as tc, generateStandaloneInDeclarationsError as ti, assertNotInReactiveContext as tl, ApplicationRef as tn, ɵɵdefineComponent as to, ProfilerEvent as tr, ɵɵpipeBind3 as ts, mergeApplicationConfig as tt, Framework as u, ɵɵProvidersFeature as ua, _objectWithoutProperties as uc, getLContext as ui, inject as ul, ComponentRef as un, ɵɵdomElementContainerStart as uo, Self as ur, ɵɵpureFunction3 as us, provideStabilityDebugging as ut, Query as v, ɵɵattachSourceLocations as va, DestroyRef as vc, isNgModule as vi, promiseWithResolvers as vl, DEHYDRATED_BLOCK_REGISTRY as vn, ɵɵelementContainerEnd as vo, TemplateRef as vr, ɵɵqueryRefresh as vs, withDomHydration as vt, ViewRef as w, ɵɵconditionalBranchCreate as wa, IMAGE_CONFIG as wc, outputBinding as wi, signal as wl, Directive as wn, ɵɵforeignContent as wo, Type as wr, ɵɵrepeaterTrackByIndex as ws, ɵɵngDeclareClassMetadata as wt, RESPONSE_INIT as x, ɵɵclassProp as xa, EnvironmentInjector as xc, isViewDirty as xi, resolveForwardRef as xl, DebugNode as xn, ɵɵelementStart as xo, TimerScheduler as xr, ɵɵrepeater as xs, withIncrementalHydration as xt, REQUEST as y, ɵɵattribute as ya, ENVIRONMENT_INITIALIZER as yc, isPromise as yi, provideBrowserGlobalErrorListeners as yl, DebugElement as yn, ɵɵelementContainerStart as yo, Testability as yr, ɵɵreadContextLet as ys, withEventReplay as yt, defaultKeyValueDiffers as z, ɵɵdeferHydrateOnViewport as za, NoopNgZone as zc, resetIncrementalHydrationRuntimeForTests as zi, ɵɵrestoreView as zl, LContext as zn, ɵɵinterpolate1 as zo, bypassSanitizationTrustStyle as zr, ɵɵstyleProp as zs, chain as zt };
